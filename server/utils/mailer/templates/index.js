...
export const coupleActivationTemplate = (name, url) => {
  return `
...
export const venueActivationTemplate = (name, url) => {
  return `
  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml">
...
<body style="
  ...
  <table style="
    ...
    <tr>
      <td align="center">
        <p style="font-size: 18px; font-weight: 400;">
          On Partnering with BeWeddy. Our team will contact with you in <br> the next 24 hours. To help onboard your
          software to your <br> website! 🙌 Let's celebrate.
        </p>
      </td>
    </tr>
    <tr style="margin-bottom: 1.5rem">
