...
const AuthLinks = () => {
  return (
    <div className="flex items-center space-x-3">
      ...
      <Link href="/register">
        <a className="min-w-[102px] flex items-center justify-center text-sm text-primary py-[11px] px-6 border-2 border-primary rounded-md font-bold font-inter hover:text-white hover:bg-primary transition-colors duration-300">
          Sign Up
        </a>
      </Link>
    </div>
