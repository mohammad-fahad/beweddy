      ...
      <div className="container py-20">
        ...
        {!user && (
          <div className="absolute z-20 mx-auto transition duration-200 left-2/4 -translate-x-2/4 -bottom-5 hover:scale-110">
            {/* <Link href="/register"> */}
            <a
              className="py-5 font-bold text-sm md:text-base lg:text-lg xl:text-xl xxl:text-2xl bg-[#ffffff] border-4 px-12 whitespace-nowrap border-primary text-primary rounded-full createButton"
