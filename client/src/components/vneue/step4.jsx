...
const Package = () => {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(addplan("none"));
    push({ query: { step: 5 } });
  };

  return (
    <CreateWebsiteContainer seo={{ title: "Couple Names" }} page="4">
      <form
        ...
        >
          <div class="grid grid-cols-12 w-full border-2 border-current rounded max-w-[1027px]  p-9 ">
            <div class="sm:col-span-6 col-span-12 p-2">
              <h1 className="font-inter font-semibold text-[32px] leading-[44px] subTitle">
                Premium Subscription Plan
              </h1>
              <h3 className="font-inter font-normal text-[24px] leading-[34px] mt-3 customLabel">
            ...
            <div class="sm:col-span-6 col-span-12 p-2 flex flex-col items-center justify-center">
              ...
              <button className="border-2 border-current rounded px-5 py-3 text-[16px] font-bold mt-3 customLabel">
                Free 30 Day Trial
              </button>
            </div>
          </div>
