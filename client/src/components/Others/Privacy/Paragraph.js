...
const Paragraph = () => {
  ...
  return (
    <div>
      <p className="text-[14px] text-left sm:text-justify customLabel">
        ...
        the rights of all Internet citizens. We vigorously oppose the sending of
        unsolicited e-messages (Spam) and will make every effort to enforce our
        strict Anti-Spam policies. We do NOT allow anyone to use our products or
        services for the purpose of sending Spam, nor do we allow our products
        or services to be referenced in Spam. If any third party sends Spam to
        anyone, his or her account will be terminated.We understand that privacy
      ...
      <p
        className={`${
          size.width < 600 ? "!pt-1" : ""
        } pt-5 text-[14px] text-left sm:text-justify customLabel`}
      >
      ...
      >
        ...
        Authorized Customers, the nature and size of the business, and the
      ...
      >
        ...
        Authorized Customers. For example, if an Authorized Customer is logged
      ...
      <p className="py-5 text-[14px] text-left sm:text-justify customLabel">
