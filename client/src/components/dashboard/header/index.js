...
const DashboardHeader = ({ title, children }) => {
  ...
  return (
    <div
      className={`max-w-[1300px] w-full min-h-[155.2px] flex pb-10 md:pb-0 py-5 md:py-0 px-6 sm:px-12 lg:pl-0 lg:pr-12 xxl:pr-0`}
    >
      {/* {!hideCoupleName && (
      ...
      >
        ...
        {children ? (
          ...
          <div className='py-[20px] space-y-3'>
            ...
            <h3 className='text-base text-center sm:text-right font-normal'>
