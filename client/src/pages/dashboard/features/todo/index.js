      ...
      <DashboardLayout shadow>
        ...
        <div className='space-y-10 shadow-box'>
          <div className='max-w-[1300px] w-full'>
            <div className='p-6 sm:p-12 xxl:pr-0'>
              <div className='relative p-8 lg:p-10 mt-5 border-4 border-gray-200 rounded-lg'>
                <div className='w-max bg-white absolute top-[-1.9rem] left-1/2 -translate-x-1/2 py-3 px-5 flex items-center space-x-3'>
                  ...
                  <h4 className='text-base md:text-xl xl:text-2xl font-medium capitalize'>
                    Just to do list
                  </h4>
