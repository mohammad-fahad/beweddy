  ...
  return (
    <>
      ...
      <DashboardLayout>
        ...
        >
          <div className="flex flex-wrap items-center gap-5 py-5 -mt-8">
            ...
            <div
              onClick={setCopied}
              className="flex cursor-pointer space-x-3 white-space-nowrap items-center py-2 px-5 border-2 border-secondary-alternative rounded-[5px] capitalize font-inter font-semibold hover:bg-secondary/5 transition duration-300"
            >
