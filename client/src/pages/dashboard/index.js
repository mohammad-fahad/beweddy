    ...
    <>
      ...
      <DashboardLayout shadow>
        ...
        <div className='shadow-box space-y-10'>
          <div className='max-w-[1300px] w-full'>
            <div className='px-6 sm:px-12 xxl:pr-0 my-10'>
              ...
              <div className='grid mb-[50px] grid-cols-2 md:grid-cols-3 xl:grid-cols-4 xxl:grid-cols-5 gap-x-5 gap-y-5 sm:gap-10 justify-center'>
                {navLinks.map((link, index) => (
                  <Link key={index} href={link.route}>
                    <a className='flex items-center justify-center flex-col space-y-5 group'>
                      ...
                      <h4 className='text-sm sm:text-lg font-semibold text-center capitalize whitespace-nowrap'>
                        {link.label}
                      </h4>
                    </a>
                  </Link>
            ...
            <div className='flex items-center flex-wrap px-[1.15rem] xs:space-y-0 space-x-3 md:space-x-5 justify-center my-[50px]'>
              <Link href='/dashboard/website/edit'>
                ...
                >
                  <PencilIcon className='w-5 h-5 hidden sm:inline-block' />
              ...
              <Link href='/dashboard/website'>
                <a
                  className={`capitalize text-xs md:text-base font-inter font-semibold border-2 border-primary rounded-[5px] bg-[#FCE0EB] py-2 px-3 md:px-5 flex items-center sm:space-x-3 hover:border-secondary/50 hover:bg-secondary-alternative/50 transition duration-300`}
                >
                  <GlobeAltIcon className='w-5 h-5 hidden sm:inline-block' />
              ...
              <Link href='/'>
                ...
                >
                  <LinkIcon className='w-5 h-5 hidden sm:inline-block' />
                  <span>Superlink</span>
                </a>
              </Link>
            </div>
