              ...
              <div className="grid mb-[50px] grid-cols-2 md:grid-cols-3 xl:grid-cols-4 xxl:grid-cols-5 gap-x-5 gap-y-5 sm:gap-10 justify-center">
                {navLinks.map((link, index) => (
                  <Link key={index} href={link.route}>
                    <a className="flex flex-col items-center justify-center space-y-5 group">
                      ...
                      <h4 className="text-sm font-semibold text-center capitalize sm:text-lg whitespace-nowrap">
                        {link.label}
                      </h4>
                    </a>
                  </Link>
