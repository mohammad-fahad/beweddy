    ...
    <Fragment>
      ...
      <DashboardLayout className="container">
        ...
        <div className="p-6 border-4 border-gray-200 rounded-lg">
          <>
            <h1 className="mb-3 text-2xl">Add Your Gift Cards</h1>
            <div className="w-48 h-[2px] md:h-[3px] bg-[#F9D1DE]">
              {/* <h1 className="w-36 h-[2px] md:h-[3px] mb-16 bg-primary"> */}
            </div>
          </>
...
text-white  font-inter font-medium text-center	"
            > */}
            <Button label='SAVE' type='submit' className='!rounded-[10px]' />
...
{
  /* // import Head from "next/head";
// import { Footer, GiftCards, Header, PageTitle } from "@components/index";
...
//     <>
//       <Head>
//         <title>BeWeddy | Gift Cardss</title>
//         <meta
//           name="description"
