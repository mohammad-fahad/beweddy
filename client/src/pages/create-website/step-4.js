  ...
  return (
    <CreateWebsiteContainer seo={{ title: 'Sent Invitations' }}>
      <motion.div exit={{ opacity: 0 }} initial='initial' animate='animate'>
        <motion.form
          className={`flex flex-col items-center justify-center md:!-mt-5`}
        ...
        >
          ...
          <motion.h2
            className='font-medium text-2xl text-center mb-8'
            variants={fadeInUp}
          >
            (Check all that apply)
          </motion.h2>
          <motion.div
            className='w-full max-w-xl flex flex-col justify-center gap-5 mb-10'
            variants={fadeInUp}
          >
            <div>
              ...
              <div className='flex items-center'>
                <Listbox value={selectedCountry} onChange={setSelectedCountry}>
                  <div className='relative -mr-2'>
                    <Listbox.Button className='bg-white cursor-pointer inline-block font-semibold py-[10px] px-4 placeholder-gray-400 border-2 border-primary rounded-lg -mr-1'>
                      <img
                ...
                <input
                  id='phone'
                  type='tel'
                  className='max-w-sm bg-white inline-block font-normal py-3 px-4 pl-5 placeholder-gray-400 border-2 border-primary rounded-lg'
